...
int main(int argc, char **argv)
{
  ...
  ros::Publisher joint1 = n.advertise<std_msgs::Float64>("/joint_1/command", 1000);
  ros::Publisher joint2 = n.advertise<std_msgs::Float64>("/joint_2/command", 1000);
  ros::Publisher joint3 = n.advertise<std_msgs::Float64>("/joint_3/command", 1000);
  ros::Publisher joint4 = n.advertise<std_msgs::Float64>("/joint_4/command", 1000);
  ros::Publisher joint5 = n.advertise<std_msgs::Float64>("/joint_5/command", 1000);
  ros::Publisher gripper = n.advertise<std_msgs::Float64>("/gripper_prismatic_joint/command", 1000);
  ros::Rate loop_rate(10);

  ros::Subscriber joints = n.subscribe("/joint_states", 1000, jointsCallback);

  // Relax services of the joints
  ros::ServiceClient client_service_joint1_relax = n.serviceClient<arbotix_msgs::Relax>("/joint_1/relax");
  ros::ServiceClient client_service_joint2_relax = n.serviceClient<arbotix_msgs::Relax>("/joint_2/relax");
  ros::ServiceClient client_service_joint3_relax = n.serviceClient<arbotix_msgs::Relax>("/joint_3/relax");
  ros::ServiceClient client_service_joint4_relax = n.serviceClient<arbotix_msgs::Relax>("/joint_4/relax");
  ros::ServiceClient client_service_joint5_relax = n.serviceClient<arbotix_msgs::Relax>("/joint_5/relax");
  ros::ServiceClient client_service_gripper_relax = n.serviceClient<arbotix_msgs::Relax>("/gripper_revolute_joint/relax");
